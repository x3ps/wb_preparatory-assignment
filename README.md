Я подготовил полностью переработанный `README.md` для GitHub — структурированный, без лишних `cite_*`, с нормальной версткой таблиц и кодовых блоков, плюс с добавленным разделом про генерацию тестовых данных.
